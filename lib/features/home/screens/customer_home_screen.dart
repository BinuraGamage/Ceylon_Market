        ...
        child: ListView(
          children: [
            ...
            if (selectedCategory.isEmpty) ...[
              ...
              const SizedBox(height: 12),
              _CategoryProductGrid(category: selectedCategory),
            ],
...
class _ShopRows extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return shopsAsync.when(
      loading: () => Column(
        children: const [
          Padding(padding: EdgeInsets.only(top: 8), child: ShimmerProductRow()),
          Padding(padding: EdgeInsets.only(top: 8), child: ShimmerProductRow()),
        ],
      ),
      error: (e, _) => ErrorBanner(
      ...
      data: (shops) {
        ...
        return Column(
          children: [for (final shop in shops) _ShopProductRow(shop: shop)],
        );
      },
    );
  }
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return productsAsync.when(
      ...
      error: (e, _) => ErrorBanner(
        ...
        onRetry: () => ref.invalidate(categoryProductsProvider(category)),
      ),
      data: (products) {
        if (products.isEmpty) {
          return const _EmptyRow(message: 'No products in this category yet.');
        }
